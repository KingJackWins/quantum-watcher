...
// package's dist/dash so `quantum-watcher web` can serve it after `npm run build`.
export default defineConfig({
  ...
  server: {
    port: 5173,
    // During frontend dev, run `quantum-watcher web` (CLI api on 4747) and `npm run dev`
