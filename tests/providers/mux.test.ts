...
describe('mux provider - chat.jsonl parsing', () => {
  it('decomposes inclusive input/output usage into quantum-watcher token fields', async () => {
    ...
    expect(call.model).toBe('claude-opus-4-8') // provider prefix stripped so quantum-watcher prices/displays it
