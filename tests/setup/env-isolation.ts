...
//
// quantum-watcher discovers sessions through a long list of provider-specific env
...
const sandbox = mkdtempSync(join(tmpdir(), 'quantum-watcher-test-env-'))
...
const CLEARED = [
  ...
  'WARP_DB_PATH',
  'ZS_DATA_DIR',
  // quantum-watcher override dirs / paths
  'CODEBURN_CACHE_DIR',
  ...
  // quantum-watcher behavior toggles (set by the dev to tweak local runs)
