...
enum ClaudeCredentialStore {
    private static let bootstrapCompletedKey = "quantum-watcher.claude.bootstrapCompleted"
    ...
    /// entries under different account names — older versions used "quantummemory"
