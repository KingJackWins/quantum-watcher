...
enum CodexSubscriptionService {
    ...
    private static let usageBlockedUntilKey = "quantumwatcher.codex.usage.blockedUntil"
    ...
    private static func fetchWithToken(_ token: String, allowOne401Recovery: Bool) async throws -> CodexUsage {
        ...
        request.setValue("Quantum Watcher", forHTTPHeaderField: "User-Agent")
        ...
        case 200:
            ...
            do {
                ...
                NSLog("QuantumWatcher: codex usage decode failed: %@", String(describing: error))
